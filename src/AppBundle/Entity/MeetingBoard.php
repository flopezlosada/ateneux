 ...
 *
 * @ORM\Table(name="meeting_board")
 * @ORM\Entity(repositoryClass="AppBundle\Entity\MeetingBoardRepository")
 */
class MeetingBoard
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="Meeting", mappedBy="meeting_board")
     */
    protected $meetings;
