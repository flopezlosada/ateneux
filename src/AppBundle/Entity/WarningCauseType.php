...
/**
 * AppBundle\Entity\WarningCauseType
 *
 * @ORM\Table(name="warning_cause_type")
 * @ORM\Entity(repositoryClass="AppBundle\Entity\WarningCauseTypeRepository")
 */
class WarningCauseType
{
    /**
     * @var integer $id
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="Warning", mappedBy="warning_cause_type")
     */
    protected $warnings;
